...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ ontop = false, position = "top", screen = s, height = 23 })
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "j",
        ...
        {description = "focus next by index / move down", group = "client"}
    ),
    awful.key({ modkey,           }, "k",
        function ()
            local c = client.focus
        ...
        {description = "focus previous by index / move up", group = "client"}
    ),
    ...
    awful.key({ modkey,           }, "l",
        ...
        {description = "increase master width factor / move right ", group = "layout"}),
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = {
          ...
          raise = true,
          keys = clientkeys,
          maximized_vertical = false,   -- So that clients don't start maximized
          maximized_horizontal = false, -- So that clients don't start maximized
          size_hints_honor = false,     -- So there's no gaps between clients
